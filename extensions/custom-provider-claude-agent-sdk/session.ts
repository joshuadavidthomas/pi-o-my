import type { ExtensionAPI, SessionManager as PiSessionManager } from "@earendil-works/pi-coding-agent";
...
// empty manager.
const ACTIVE_CLAUDE_SESSION_MANAGER_KEY = Symbol.for("pi-o-my.claude-agent-sdk.active-session-manager");
