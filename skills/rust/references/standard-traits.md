...
Which std traits to implement, when to derive vs implement manually, and the conversion trait hierarchy. Loaded from [traits.md](../traits.md) when you need the full picture beyond Rule 2 in the SKILL.md.
