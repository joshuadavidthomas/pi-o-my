...
After completing all steps, **call the `factCheck` tool on your own output**. The fact-check catches:
...
5. **Fact-check result** — Output of `factCheck` on this evaluation, including the phrase-shape check.
