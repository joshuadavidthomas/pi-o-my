...
After completing all layers, **call the `factCheck` tool on your own output**. The fact-check tool catches:
...
7. **Fact-check result** — Output of `factCheck` on this evaluation, including the phrase-shape check.
